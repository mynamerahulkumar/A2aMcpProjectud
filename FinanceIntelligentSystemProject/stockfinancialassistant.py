...
class StockAssistant(OpenAIA2AServer):
    ...
    def handle_message(self, message):
        ...
        if message.content.type == "text":
            ...
            if ("stock" in text or "price" in text or "trading" in text) and any(company in text for company in ["apple", "microsoft", "google", "amazon", "tesla", "facebook", "meta","nvidia"]):
    ...
    def _get_stock_info(self, message):
        ...
        try:
            ...
            print("openai_response-stock-assistant-----",openai_response,"\n")

            company_name = openai_response.content.text.strip()
            company_name = company_name.strip('"\'.,')
            print("company_name-stock-assistant-----",company_name)
            ...
            print("ticker_response-stock-assistant-----",ticker_response)
            ...
            print("ticker_match-stock-assistant-----",ticker_match,"\n")
